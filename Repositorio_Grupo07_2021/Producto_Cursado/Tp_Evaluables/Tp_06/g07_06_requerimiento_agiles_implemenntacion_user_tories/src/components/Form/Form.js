...
export const MyForm = () => {
    ...
    const validateExpirationDate = (date) => {
        ...
        const year = parseInt(date.substring(3, 5))
                        ...
                        <Grid item xs={12} lg={11}>
                            <FormControl required fullWidth error={errorPedidoDescripcion}>
                                <TextField
                                    ...
                                    fullWidth
                                    required
                                    placeholder='Agregue una descripción de lo que desea enviar'
                        ...
                        <Grid item xs={12} lg={11} style={{ textAlign: "start" }}>
                            ...
                            >
                                {adjuntos.map((adjunto) => {
                                    return (
                                        <Grid item xs={12} style={{ textAlign: "start" }} container
                                            direction="row"
                                            justify="left"
                                            alignItems="left"
                                            spacing={1}>
                                            ...
                                            {nombreImagen && (
                                                <Grid item xs={12} >
                                                    ...
                                                    />
                                                    <Heading style={{ margin: "0" }} as="h5" size="md">
                                                        Vista previa
                                                    </Heading>
                                                </Grid>
                                            )}
                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    ...
                                    {metodoEntrega === "FechaHora" && (
                                        <>
                                            <Grid item xs={12}>
                                                <FormControl fullWidth required error={errorFechaEntrega}>
                                                    <MuiPickersUtilsProvider
                                                        libInstance={moment}
                                                        utils={DateFnsUtils}
                                                        locale={es}
    ...
    const errorEntrega2 =
        (calleEntrega.length === 0 || errorCalleEntrega) ||
            (numeroEntrega.length === 0 || errorNumeroEntrega) ||
    ...
    const errorPago2 = (metodoPago === 'efectivo' && montoEfectivo.length === 0) ?
        true : (metodoPago === 'tarjeta' && (nroTarjeta.length === 0 ||
            (cvcTarjeta.length === 0 || errorCVC) ||
            (nombreTitular.length === 0 || errorNombreApellidoTar) ||
            fechaVencimientoTarjeta.length === 0)) ? true : false;
